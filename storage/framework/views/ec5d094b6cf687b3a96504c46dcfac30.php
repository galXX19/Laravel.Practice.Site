...
<?php $component->withAttributes(['class' => 'p-10']); ?>
            <div
                ...
                <img
                    ...
                    <h3 class="text-2xl mb-2"><?php echo e($listing->title); ?>r</h3>
...
<?php $component->withAttributes(['class' => 'mt-4 p-2 flex space-x-6']); ?>
            ...
            <form method="POST" action="/listings/<?php echo e($listing->id); ?>">
                ...
                <button class="text-black-500"><i class="fa-solid fa-trash"></i> Delete</button>
            </form>
...
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?><?php /**PATH /Users/miragalperina/laragigs/resources/views/listings/show.blade.php ENDPATH**/ ?>